								...
								if (dataOriginal.charAt(0) == '*') {	//当数据的第一个字符是*号时表示数据接收完成，开始解析
									...
									if (elements == null || elements.length < 1) {	//检查数据是否解析正确
										...
										try {
											...
											tem.setText(elements[1] + " ℃");
											hum.setText(elements[2] + " %");
											pa.setText(elements[3] + " hPa");
											rain.setText(elements[4] + " mm");
											win_sp.setText(elements[5] + " lux");
											win_dir.setText(elements[6] + " °");
